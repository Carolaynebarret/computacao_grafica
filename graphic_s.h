...
void EquacaoGeral(int p1[2],int p2[2]){
    ...
    if(valorx1 == valorx2){
		...
		//A rasterizacao dos pontos sera feita atraves da funcao PutPixel que rasteriza um ponto na memoria de video, recebendo como parametros as coordenadas (x,y) do pixel na tela e uma cor em RGBA
